...
public class EurekaInstanceConfigBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) {
        ...
        if (bean instanceof EurekaInstanceConfigBean) {
            ...
            instanceConfigBean.setInstanceId(fargateIp + ":employee-service:10002");
            instanceConfigBean.setIpAddress(fargateIp);
            instanceConfigBean.setHostname(fargateIp);
            instanceConfigBean.setStatusPageUrl("http://" + fargateIp + ":10002/actuator/info");
            instanceConfigBean.setHealthCheckUrl("http://" + fargateIp + ":10002/actuator/info");
        }
